 ...
 */
export declare const all: (fn1: (x: any) => boolean) => (arr: any[]) => boolean;
export declare const any: (fn1: (x: any) => boolean) => (arr: any[]) => boolean;
/** Given a class, returns a Predicate function that returns true if the object is of that class */
export declare const is: (ctor: Function) => (x: any) => boolean;
